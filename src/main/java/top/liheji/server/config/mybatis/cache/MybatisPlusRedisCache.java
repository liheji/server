package top.liheji.server.config.mybatis.cache;
...
public class MybatisPlusRedisCache implements Cache {
    ...
    public void putObject(Object key, Object value) {
        ...
        try {
            //将key加密后存入
            redisTemplate.opsForHash().put(this.id, CypherUtils.encodeToHash(key.toString(), MessageDigestEnum.SHA_256), value);
        } catch (Exception e) {
    ...
    public Object getObject(Object key) {
        ...
        try {
            if (key != null) {
                return redisTemplate.opsForHash().get(this.id, CypherUtils.encodeToHash(key.toString(), MessageDigestEnum.SHA_256));
            }
        } catch (Exception e) {
    ...
    public Object removeObject(Object key) {
        ...
        try {
            if (key != null) {
                redisTemplate.opsForHash().delete(this.id, CypherUtils.encodeToHash(key.toString(), MessageDigestEnum.SHA_256));
            }
        } catch (Exception e) {
