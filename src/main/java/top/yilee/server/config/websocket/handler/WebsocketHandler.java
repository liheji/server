package top.yilee.server.config.websocket.handler;
...
import top.yilee.server.config.websocket.vo.SocketSessionVo;
import top.yilee.server.config.websocket.vo.SshConnectVo;
import top.yilee.server.config.websocket.vo.SshServerVo;
import top.yilee.server.util.FileUtils;
...
public class WebsocketHandler extends AbstractWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws IOException {
        ...
        Map<String, Object> obj = JsonUtils.parseObject(payload);
        ...
        switch (action) {
            case CONNECT:
                try {
                    SshConnectVo connect = JsonUtils.parseObject(payload, SshConnectVo.class);
