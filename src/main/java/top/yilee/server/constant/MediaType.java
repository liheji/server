...
public class MediaType {
    ...
    private static final HashMap<String, String> MEDIA_TYPE = new HashMap<String, String>() {{
    ...
    private MediaType(String suffix, String mediaType) {
        this.suffix = suffix;
    ...
    public boolean isChemical() {
        return mediaType.startsWith("chemical");
    }
    ...
    public static String guessMediaType(String fileName) {
        ...
        String fileExt = MEDIA_TYPE.get(fileName.substring(index));
        return fileExt == null ? "application/octet-stream" : fileExt;
    }

    public static MediaType guessMediaTypeClass(String fileName) {
        MediaType ret = new MediaType(".bin", "application/octet-stream");
        if (fileName == null) {
            return ret;
        }
        ...
        String type = MEDIA_TYPE.get(fileName.substring(index));
        return type == null ? ret : new MediaType(fileName.substring(index), type);
    }
}
