...
import top.yilee.server.mapper.LatexAccountMapper;
import org.springframework.stereotype.Service;
import top.yilee.server.util.JsonUtils;
import top.yilee.server.vo.LatexRegisterVo;
...
public class LatexAccountServiceImpl extends ServiceImpl<LatexAccountMapper, LatexAccount>
    ...
    private LatexAccount registerByAccount(HttpServletRequest req) {
        ...
        Map<String, Object> data = JsonUtils.parseObject(dataStr);
        if (ObjectUtils.isEmpty(data) || data.get("result").equals(1)) {
            return null;
        }
